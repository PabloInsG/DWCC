...
*/
/*        let usuario = Number(prompt(`Introduce un numero para comprobar si es primo o no:`));
...
/*
        let usuario = parseInt(prompt(`Introduzca su edad:`));
        ...
        document.write(puedeVotar(usuario));


        let usuario = parseInt(prompt("Introduce los grados:"));
        ...
        document.write(celsiusToFahrenheit(usuario));
